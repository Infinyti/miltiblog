                    ...
                    <form action="{{ url('admin/user/update/'.$user->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Имя:</label>
                                <div class="col-md-9">
                                    <input name="name" type="text" required class="form-control" value="{{ $user->name }}" placeholder="Имя">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Почта:</label>
                                <div class="col-md-9">
                                    <input name="email" type="text" required class="form-control" value="{{ $user->email }}" placeholder="email">
                                </div>
                            </div>
